...
# Mann-Whitney | one-tail | Hyp: the median at Early TP is less than at Late TP
...
# Mann-Whitney | One-tail | Hyp: the median at Early TP is less than at Late TP
# alternative = greater
wilcox.test(liver$area ~ liver$TP, paired = FALSE, conf.int = TRUE, , alternative = "less", conf.level = 0.95, exact = FALSE, correct = TRUE)
...
# viz
# Mann-Whitney | One-tail | alternative = less
# Hyp: the median at Early TP is less than at Late TP
# With two-tails p = 0.061 > hyp: the area is different between the early and late time points
gran <- liver |>
  ...
  annotate("text", x = "Early", y = 78000, label = "italic(p) == 0.96", parse = T, size = 4.3) +
  ggtitle("") +
  xlab("") +
